...
def make_proba_distribution(
    ...
    if dist_kwargs is None:
        dist_kwargs = {}
    return CategoricalDistribution(int(action_space[0]), **dist_kwargs)
...
def make_masked_proba_distribution(action_space) -> MaskableDistribution:
    """
    Return an instance of Distribution for the correct type of action space
    ...
    :return: the appropriate Distribution object
    """
    return MaskableCategoricalDistribution(int(action_space[0]))
